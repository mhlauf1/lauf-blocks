...
export interface AuthSplitContent {
...
export function AuthSplit({ content }: { content: AuthSplitContent }) {
  return (
    <section className="flex min-h-screen">
      <div className="flex flex-1 items-center justify-center px-6 py-24">
        ...
        >
          ...
          <motion.form
            ...
            className={
              content.socialProviders ? "space-y-4" : "mt-8 space-y-4"
            }
          >
            <div>
              <label
                htmlFor="split-signin-email"
                className="block text-sm font-medium text-foreground"
              >
                {content.fields.email.label}
              </label>
              <input
                id="split-signin-email"
                name="email"
                type="email"
                required
      ...
      <div className="hidden flex-1 items-center justify-center border-l border-border bg-muted/30 p-12 lg:flex">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <blockquote className="text-lg leading-relaxed text-foreground">
            &ldquo;{content.panel.testimonial.quote}&rdquo;
          </blockquote>
          <div className="mt-6">
            <p className="font-heading text-sm font-semibold text-foreground">
              {content.panel.testimonial.name}
            </p>
            <p className="mt-0.5 text-sm text-muted-foreground">
              {content.panel.testimonial.role}
            </p>
          </div>
        </motion.div>
      </div>
